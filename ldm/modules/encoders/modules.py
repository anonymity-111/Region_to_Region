...
class FrozenOpenCLIPImageEncoder(AbstractEncoder):
    ...
    def __init__(
        self, arch="ViT-H-14", version="laion2b_s32b_b79k", device="cuda", freeze=True
    ):
        super().__init__()
        ...
        self.image_std = (
            torch.tensor([0.26862954, 0.26130258, 0.275777])
            .unsqueeze(0)
            .unsqueeze(-1)
            .unsqueeze(-1)
        )
        self.projector_token = nn.Linear(1280, 768)
        self.projector_embed = nn.Linear(1024, 768)
